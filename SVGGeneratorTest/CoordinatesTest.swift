...
class CoordinatesTest: XCTestCase {
    ...
    func test_Coordinates_operator_plus() {
    ...
    func test_Coordinates_operator_minus() {
    ...
    func test_Coordinates_operator_plus_equal() {
